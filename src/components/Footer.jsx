...
const Footer = () => {
    return (
        <div style={{position:"fixed", bottom:"0"}} className="card text-white bg-primary mt-5 text-center">
            <div className='container'>
                    ...
                    <div className="col">
                        <div className="card-body">
                            ...
                            <a className="card-link" href="https://www.canva.com/design/DAFIIFIdRwA/iJ3xZc15-uhYUoMKxaTHKw/view?utm_content=DAFIIFIdRwA&utm_campaign=designshare&utm_medium=link&utm_source=publishsharelink"
                                ...
                                <img className="card-img" src="https://cdn-icons-png.flaticon.com/512/3135/3135731.png" alt="CV" style={{ width: "20%" }} />
                        ...
                        <div className="card-body ">
                            ...
                            <div className='row'>
                                ...
                                <a href="https://www.linkedin.com/in/rony-puche-a80275234/" target="_blank" rel="noopener noreferrer">
                                    <img className="card-img mt-2" style={{ width: "35%" }} src="https://cdn-icons-png.flaticon.com/512/174/174857.png" alt="Linkedin" />
                            ...
                            <div className="col">
                                <a href="https://github.com/rony171998" target="_blank" rel="noopener noreferrer">
                                    <img className="card-img mt-2" style={{ width: "35%" }} src="https://cdn-icons-png.flaticon.com/512/733/733553.png" alt="Github" />
                ...
                <div >
                    <h4 className="card-title  text-white text-center">Rony Puche web &copy; 2022</h4>
                </div>
